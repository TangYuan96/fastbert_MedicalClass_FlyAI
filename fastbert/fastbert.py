...
from .uer.utils.optimizers import AdamW, MYSchedule, WarmupLinearSchedule
...
class FastBERT(nn.Module):
    ...
    def _fine_tuning_backbone(self,
        ...
        scheduler =  MYSchedule(optimizer, \
                  warmup_steps=train_steps*warmup, t_total=train_steps,  last_epoch=-1)
        # fine-tuning
        best_acc = 0.0
